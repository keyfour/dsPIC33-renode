...
namespace Antmicro.Renode.Peripherals.CPU
{
    ...
    public class DsPic33CPU : BaseCPU, IGPIOReceiver, ITimeSink, IDisposable
    {
        public DsPic33CPU(string cpuType, IMachine machine, Endianess endianness = Endianess.LittleEndian, CpuBitness bitness = CpuBitness.Bits32)
